...
<html lang="en">
  <head>
    ...
    <title>Music all around you</title>
  </head>
  <body>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <div class="jumbotron text-center">
        ...
        <p class="lead">Musik adalah suara yang disusun sedemikian rupa sehingga mengandung irama, lagu, nada, dan keharmonisan terutama dari suara yang dihasilkan dari alat-alat yang dapat menghasilkan irama. Walaupun musik adalah sejenis fenomena intuisi, untuk mencipta, memperbaiki dan mempersembahkannya adalah suatu bentuk seni. Mendengar musik adalah sejenis hiburan. Musik adalah sebuah fenomena yang sangat unik yang bisa dihasilkan oleh beberapa alat musik.</p>
        <hr class="my-4">
        <p>FL Studio (mulanya Fruity Loops) adalah sebuah aplikasi stasiun kerja audio digital yang digunakan untuk merekam, mengubah, dan membuat audio. FL Studio dikembangkan oleh perusahaan bernama Image-Line. Pada tahun 2014, FL Studio termasuk aplikasi audio yang banyak peminatnya di seluruh dunia. </p>
        <p class="lead">
            <a class="btn btn-primary btn-lg" href="https://www.image-line.com/" role="button">FL STUDIO</a>
        </p>
    </div>
